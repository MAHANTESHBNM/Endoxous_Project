...
export const BLOCK_CATEGORY_REQUEST = "BLOCK_CATEGORY_REQUEST";
export const BLOCK_CATEGORY_SUCCESS = "BLOCK_CATEGORY_SUCCESS";
export const BLOCK_CATEGORY_RESET = "BLOCK_CATEGORY_RESET";
export const BLOCK_CATEGORY_FAIL = "BLOCK_CATEGORY_FAIL";

export const UNBLOCK_CATEGORY_REQUEST = "UNBLOCK_CATEGORY_REQUEST";
export const UNBLOCK_CATEGORY_SUCCESS = "UNBLOCK_CATEGORY_SUCCESS";
export const UNBLOCK_CATEGORY_RESET = "UNBLOCK_CATEGORY_RESET";
export const UNBLOCK_CATEGORY_FAIL = "UNBLOCK_CATEGORY_FAIL";
